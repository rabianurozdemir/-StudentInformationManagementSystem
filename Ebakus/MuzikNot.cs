    ...
    class MuzikNot : IOgretmenNot
    {
        ...
        public void notGoster(DataGridView dataGridView1, string sinif)
        {
            ...
            while (reader.Read())
            {
                ...
                not1 = Convert.ToDouble(reader["notMuzikBir"]);
                not2 = Convert.ToDouble(reader["notMuzikIki"]);
                notDavranis = Convert.ToDouble(reader["notMuzikDavranis"]);
                notOrtalama = Convert.ToDouble(reader["notMuzikOrtalama"]);
        ...
        public void notGuncelle(string[] notlar, string numara)
        {
            ...
            connection.Open();
            MySqlCommand komut = new MySqlCommand("update notOgrenci set notMuzikBir='" + notlar[0] + "', notMuzikIki='" + notlar[1] + "', notMuzikDavranis='" + notlar[2] + "', notMuzikOrtalama='" + notOrtalama.ToString() + "' where numara='" + numara + "'");
