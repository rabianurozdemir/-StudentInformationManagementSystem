    ...
    class TurkceNot : IOgretmenNot
    {
        ...
        public void notGoster(DataGridView dataGridView1, string sinif)
        {
            ...
            while (reader.Read())
            {
                ...
                not1 = Convert.ToDouble(reader["notTurkceBir"]);
                not2 = Convert.ToDouble(reader["notTurkceIki"]);
                notDavranis = Convert.ToDouble(reader["notTurkceDavranis"]);
                notOrtalama = Convert.ToDouble(reader["notTurkceOrtalama"]);
        ...
        public void notGuncelle(string[] notlar, string numara)
        {
            ...
            connection.Open();
            MySqlCommand komut = new MySqlCommand("update notOgrenci set notTurkceBir='" + notlar[0] + "', notTurkceIki='" + notlar[1] + "', notTurkceDavranis='" + notlar[2] + "', notTurkceOrtalama='" + notOrtalama.ToString() + "' where numara='" + numara + "'");
